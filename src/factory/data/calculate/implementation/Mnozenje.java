...
public class Mnozenje implements CalculateStrategyInterface<Data, Data> {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		List<Data> data=new A6Strategy().readFile(PropertyParser.parseToHashMap().get("mnozenje").path().toString());
		
		List<Data> rez=new Mnozenje().calculate(data);
